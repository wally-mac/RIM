...
project_path = r"C:\Users\karen\Box\0_ET_AL\NonProject\etal_Drone\2019\Inundation_sites\Utah\Mill_Creek\mill_mappedDONTRUN"

### name for new DCE folder

DCE_fold = 'DCE_02'

### file locations for RS context inputs
