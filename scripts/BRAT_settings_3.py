...
def BRAT_settings (folder, BRAT, BRAT_out, SP_cut, grad_cut):
    ...
    ## SP
    arcpy.SelectLayerByAttribute_management('BRAT_out', 'SUBSET_SELECTION', "\"iHyd_SPLow\" <= SP_cut")
    ## populate setting field
    ...
    # floodplain setting
    ## gradient
    arcpy.SelectLayerByAttribute_management('BRAT_out', 'SWITCH_SELECTION', "\"iGeo_Slope\" <= grad_cut")
    ## SP
    arcpy.SelectLayerByAttribute_management('BRAT_out', 'SUBSET_SELECTION', "\"iHyd_SPLow\" >= SP_cut")
    ## populate setting field
    with arcpy.da.UpdateCursor('BRAT_out', 'setting') as Ucursor:
